...
typedef struct sDriverRecordData {
   ...
   int ping_interval;  // expressed in thread cycle counts ~ 0.1 seconds
...
static long init_record_mbbi (mbbiRecord* prec)
{
   ...
   pDRD->ping_interval = 200; // approx 20 seconds - fixed for now, maybe extract from INP field.
